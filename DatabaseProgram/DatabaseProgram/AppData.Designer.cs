...
namespace DatabaseProgram {
    ...
    public partial class AppData : global::System.Data.DataSet {
        ...
        public partial class PlayersDataTable : global::System.Data.TypedTableBase<PlayersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PlayersRow AddPlayersRow(string FullName, string Nationality, string Age, string Position, string Description, byte[] Image) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PlayersRow FindByPlayersID(int PlayersID) {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new global::System.Data.UniqueConstraint("Constraint1", new global::System.Data.DataColumn[] {
                                this.columnPlayersID}, true));
                this.columnPlayersID.AutoIncrement = true;
                this.columnPlayersID.AutoIncrementSeed = 1;
                this.columnPlayersID.AllowDBNull = false;
                this.columnPlayersID.Unique = true;
        ...
        public partial class PlayersRow : global::System.Data.DataRow {
            ...
            public int PlayersID {
                get {
                    return ((int)(this[this.tablePlayers.PlayersIDColumn]));
                }
                set {
                    this[this.tablePlayers.PlayersIDColumn] = value;
                }
            }
            ...
            public string FullName {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'FullName\' in table \'Players\' is DBNull.", e);
                    }
                }
                set {
            ...
            public byte[] Image {
                get {
                    try {
                        return ((byte[])(this[this.tablePlayers.ImageColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public bool IsFullNameNull() {
                return this.IsNull(this.tablePlayers.FullNameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetFullNameNull() {
                this[this.tablePlayers.FullNameColumn] = global::System.Convert.DBNull;
            }
...
namespace DatabaseProgram.AppDataTableAdapters {
    ...
    public partial class PlayersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Players` WHERE ((`PlayersID` = ?) AND ((? = 1 AND `FullName` IS NULL) OR (`FullName` = ?)) AND ((? = 1 AND `Nationality` IS NULL) OR (`Nationality` = ?)) AND ((? = 1 AND `Age` IS NULL) OR (`Age` = ?)) AND ((? = 1 AND `Position` IS NULL) OR (`Position` = ?)) AND ((? = 1 AND `Description` IS NULL) OR (`Description` = ?)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_PlayersID", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "PlayersID", global::System.Data.DataRowVersion.Original, false, null));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Players` (`FullName`, `Nationality`, `Age`, `Position`, `Description" +
                "`, `Image`) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Players` SET `FullName` = ?, `Nationality` = ?, `Age` = ?, `Position` = ?, `Description` = ?, `Image` = ? WHERE ((`PlayersID` = ?) AND ((? = 1 AND `FullName` IS NULL) OR (`FullName` = ?)) AND ((? = 1 AND `Nationality` IS NULL) OR (`Nationality` = ?)) AND ((? = 1 AND `Age` IS NULL) OR (`Age` = ?)) AND ((? = 1 AND `Position` IS NULL) OR (`Position` = ?)) AND ((? = 1 AND `Description` IS NULL) OR (`Description` = ?)))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_PlayersID", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "PlayersID", global::System.Data.DataRowVersion.Original, false, null));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DatabaseProgram.Properties.Settings.Default.MojaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PlayersID, FullName, Nationality, Age, [Position], Description, [Image] FR" +
                "OM Players";
        ...
        public virtual int Fill(AppData.PlayersDataTable dataTable) {
        ...
        public virtual AppData.PlayersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AppData.PlayersDataTable dataTable = new AppData.PlayersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AppData.PlayersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_PlayersID, string Original_FullName, string Original_Nationality, string Original_Age, string Original_Position, string Original_Description) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_PlayersID));
        ...
        public virtual int Update(string FullName, string Nationality, string Age, string Position, string Description, byte[] Image, int Original_PlayersID, string Original_FullName, string Original_Nationality, string Original_Age, string Original_Position, string Original_Description) {
            if ((FullName == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_PlayersID));
            if ((Original_FullName == null)) {
